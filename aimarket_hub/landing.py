...
<p class="subtitle" style="margin-bottom:16px;">All 15 plugins installable via pip. Each auto-discovers and registers with the hub at startup. Try live routes on the <a href="/plugins/demo">plugin demo page</a>.</p>
<div class="plugin-grid">

<div class="plugin-card"><h3>aimarket-provenance</h3><div class="cat">compliance</div><p>Ed25519 W3C VC receipts on every invoke. Auto-attached provenance_receipt with public verify URL.</p><code>pip install aimarket-provenance</code></div>
