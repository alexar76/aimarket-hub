...
def verify_and_store(
    *,
    ...
    try:
        ...
        # A duplicate receipt or a duplicate (channel, nonce) is a replay, not a server
        # error — the buyer's client has to produce a fresh authorization.
        raise AuthorizationRejected(str(exc)) from exc
