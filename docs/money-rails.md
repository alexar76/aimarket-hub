...
| **Channels / escrow** | a deposit, by default to the operator's wallet | **yes, by default** | not paid by this rail | see [KI-11](../../docs/known-issues.md) |
...
[`MarketSplitter`](../../contracts/evm/src/MarketSplitter.sol) fixes that without
...
Remaining open items are tracked in [KI-11](../../docs/known-issues.md).
